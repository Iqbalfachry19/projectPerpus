...
if (isset($_GET['id'])) {
    ...
    $SqlQuery = query("select * from kembali where id_kembali ='$id' && username ='$user'  LIMIT " .$limitStart.",".$limit);
} else {
    if($kolomCari=="" && $kolomKataKunci==""){
        $SqlQuery = mysqli_query($conn, "SELECT * FROM kembali where username ='$user' LIMIT ".$limitStart.",".$limit);
      }else{
        //kondisi jika parameter kolom pencarian diisi
        $SqlQuery = mysqli_query($conn, "SELECT * FROM kembali WHERE username ='$user' &&  $kolomCari LIKE '%$kolomKataKunci%' LIMIT ".$limitStart.",".$limit);
      }
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form class="form-inline" >
            ...
            <a href="pengembaliana.php" class="btn btn-danger">Reset</a>
          </form>
        </div>
      </div>
    </div>
...
<?php } else{
   ...
   <ul class="pagination justify-content-center " >
     ...
     <?php
         ...
         if($kolomCari=="" && $kolomKataKunci==""){
         ?>
           <li class="page-item"><a class="page-link" href="pengembaliana.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
      <?php     
         }else{
       ?> 
         <li class="page-item"><a class="page-link" href="pengembaliana.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Previous</a></li>
        <?php
          } 
       }
     ?>
    ...
    if (isset($_GET['id'])) {
     $id = $_GET['id']; // Getting parameter value inside PHP variable
      ...
      $SqlQuery = mysqli_query($conn,"select * from kembali where id_kembali ='$id' && username ='$user' LIMIT " .$limitStart.",".$limit);
 } else {
     ...
     if($kolomCari=="" && $kolomKataKunci==""){
         $SqlQuery = mysqli_query($conn, "SELECT * FROM kembali where username ='$user' ");
       }else{
         //kondisi jika parameter kolom pencarian diisi
         $SqlQuery = mysqli_query($conn, "SELECT * FROM kembali WHERE username ='$user' && $kolomCari LIKE '%$kolomKataKunci%' ");
       }
       ...
       for($i = $startNumber; $i <= $endNumber; $i++){
         ...
         if($kolomCari=="" && $kolomKataKunci==""){
     ?>
         <li<?php echo $linkActive; ?>><a class="page-link" href="pengembaliana.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
 
     <?php
       }else{
         ?>
         <li<?php echo $linkActive; ?>><a class="page-link" href="pengembaliana.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
         <?php
       }
     }
     ?>
     ...
     <?php
      ...
      if($kolomCari=="" && $kolomKataKunci==""){
         ?>
           <li class="page-item"><a class="page-link" href="pengembaliana.php?page=<?php echo $linkNext; ?>">Next</a></li>
      <?php     
         }else{
       ?> 
          <li class="page-item"><a class="page-link" href="pengembaliana.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $linkNext; ?>">Next</a></li>
     <?php
       }
     }
     ?>
...
?>
<li<?php echo $linkActive; ?>><a class="page-link" href="pengembaliana.php?id=<?php echo $id; ?>"><?php echo $i; ?></a></li>
